---
title: "The importance of targets"
date: 2026-07-08T08:00:00+02:00
draft: false
description: "Results could always be better — but often the problem isn't the entry, it's the exit. Here's what happens when you don't have a target."
cover:
  image: "m1-entry.jpg"
...
Here is another example of a trade using the strategy from [Buy the dips, sell the rallies](/blog/2026-06-24-buy-the-dips-sell-the-rallies/) — almost the same setup, but the result could have been better. The entry was fine. The problem was the exit: no target, and an emotional decision to get out early.

## The trade — M1 entry

{{< figure src="m1-entry.jpg" caption="M1 — price rejection at Day Open with Inside Bar (IB), Acceleration Correction visible in eWaves, 3.20R exit" >}}
...
{{< figure src="m1-full.jpg" caption="M1 — the full move. A target at the right level would have captured close to 6R." >}}
...
{{< figure src="m15-target.jpg" caption="M15 — Overnight High (ONH) supply/demand zone was the obvious target. Entry and both exits marked." >}}
