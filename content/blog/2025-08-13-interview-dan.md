---
title: "Trader Interview: Dan — London Session DAX Trader"
date: 2025-08-13T08:00:00+02:00
draft: false
description: "The first in a trader interview series — a standard set of questions covering background, psychology, strategy, and lessons learned. This one's from Dan, who runs this site."
categories: ["Interviews"]
tags: ["trader interview", "DAX", "London Session", "psychology"]
---

*Part of an ongoing trader interview series — the same set of questions put to different traders, covering background, psychology, strategy, and lessons learned. Originally published on [Traders Questions](https://tradersquestions.netlify.app/dan).*
...
Meditation is a good tool, and I do have a checklist and a pre-session where I write how I'm feeling, how I slept, etc.
...
1. **DAX (M1)**: Testing the overnight high after an impulsive move up and retracing to test the M15 target zone and FVG. The impulsive move, ABC retrace, hammer, and AC gave me confidence to enter the trade. I closed after a rejection at the HTF fib level.
2. **NASD**: A flip of the day close level and then a test of that level. Closed at London close.
3. **UJ**: Flipping ONH after an impulsive move up. ABC retrace to ONH, AC with IB. Entered on IB. Closed trailing candle after the HTF level was hit.
