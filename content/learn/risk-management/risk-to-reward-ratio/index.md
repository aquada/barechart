...
Win rate gets talked about far more than it deserves. Risk to reward is the number that actually decides whether a strategy makes money, and it's worth understanding properly rather than treating it as a vague "good ratio" you're supposed to aim for.
...
The ratio gets decided the moment you set your stop and target, and then it's quietly abandoned the moment the trade is actually open. Moving a stop further away to avoid being wrong turns a planned 1R loss into an unplanned 2R one, while taking profit early out of nerves turns a planned 3R winner into a 1R one, and both of those wreck the maths just as effectively as taking a genuinely bad setup. This is the exact mistake covered in [The importance of targets](/blog/2026-07-08-the-importance-of-targets/), where a clean entry with no exit plan behaves like a coin flip regardless of how good the entry was.

---

## Setting it before you're in the trade

Know your invalidation, the point where the idea is simply wrong, before you know your target, since that's your stop. Then find a realistic target based on actual structure, the next level, the next zone, the next swing point, rather than just wherever gives you a nice round number. If the resulting ratio doesn't clear whatever minimum you've set for yourself, that's information worth having before risking anything, not after.
...
- A high win rate can still lose money, and a low win rate can still be profitable, since neither means anything alone
