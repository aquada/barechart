...
description: "How to read a single candlestick: open, high, low, close, and what the body and wicks tell you."
section: "Reading Charts"
section_slug: "reading-charts"
order: 1
weight: 1
status: "published"
tags: ["candlestick basics", "reading charts"]
related: ["candlestick-patterns", "chart-types-and-timeframes"]
---

Before any pattern makes sense, a single candle has to make sense, because every pattern is really just a handful of these stacked next to each other and read as a group.
