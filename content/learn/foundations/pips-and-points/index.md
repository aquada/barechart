---
title: "Pips and Points"
description: "What a pip and a point measure, and how to read price movement in either unit."
section: "Foundations"
section_slug: "foundations"
order: 9
weight: 9
status: "published"
tags: ["foundations", "pips", "points"]
...
- A pip is the standard forex unit of movement, the fourth decimal place for most pairs, and the second decimal for yen pairs
- A point is the equivalent unit for indices and other instruments, one full unit of that instrument's own price
- Neither unit tells you the actual money value of a move on its own; that depends on position size
- Always check what unit an instrument is quoted in before assuming a "50 point move" and a "50 pip move" mean anything comparable
