---
title: "Elliott Waves"
description: "The five-wave impulse and three-wave correction structure, and how to use it without overfitting."
section: "Market Structure"
section_slug: "market-structure"
order: 6
weight: 6
status: "published"
tags: ["market structure", "elliott wave", "impulse wave", "corrective wave"]
related: ["impulse-and-corrective-waves", "fair-value-gaps", "what-is-market-structure"]
---

Ralph Nelson Elliott, an accountant rather than a trader by background, spent the 1930s studying decades of stock market data and concluded that price doesn't move randomly, it moves in a repeating rhythm of five waves one way followed by three waves back, over and over, at every size from a few hours to several decades. That rhythm is what Elliott Wave theory tries to count, and it's built directly on the [impulse and corrective](/learn/market-structure/impulse-and-corrective-waves/) distinction from the previous article.

---

## The five-three structure

{{< figure src="elliott-wave.png" caption="A complete cycle: five impulse waves (1-2-3-4-5) with the trend, followed by a three-wave correction (A-B-C) against it." >}}
