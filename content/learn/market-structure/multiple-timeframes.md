---
title: "Trading Multiple Timeframes"
description: "Using a higher timeframe for bias and a lower one for entry, without conflicting signals."
section: "Market Structure"
section_slug: "market-structure"
order: 10
weight: 10
status: "published"
tags: ["market structure", "multiple timeframes", "top-down analysis"]
related: ["what-is-market-structure", "liquidity-and-stop-hunts", "order-blocks"]
---
...
The usual approach starts on a higher timeframe and works down. The higher timeframe sets the bias, is this instrument trending or ranging, and in which direction, using the same [higher-high, higher-low framework](/learn/market-structure/what-is-market-structure/) covered earlier in this section. A middle timeframe narrows that down to specific zones to watch, an [order block](/learn/market-structure/order-blocks/) or [supply and demand zone](/learn/market-structure/supply-and-demand/) sitting inside that bias. The lowest timeframe is where the actual entry gets timed, watching for a break of structure or a setup at the zone once price arrives there.
